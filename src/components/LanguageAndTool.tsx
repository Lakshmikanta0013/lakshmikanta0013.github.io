...
const LanguageAndTool = () => {
  return (
    <div className="mx-auto -mt-20 flex w-full flex-col overflow-hidden rounded-3xl bg-white p-3 shadow-lg dark:bg-dark-700 md:w-[96%] md:flex-row md:p-4 lg:p-6">
      <div className="mb-4 flex flex-col border-b-2 border-dashed border-dark-300 pb-4 md:mb-0 md:mr-4 md:w-1/3 md:border-b-0 md:border-r-2 md:pb-0 md:pr-4 lg:w-[50%]">
      ...
      <div className="mb-4 flex flex-col border-b-2 border-dashed border-dark-300 pb-4 md:mb-0 md:mr-4 md:w-1/3 md:border-b-0 md:border-r-2 md:pb-0 md:pr-4 lg:w-[25%]">
        <div className="mx-auto mb-5 rounded-full bg-blue-300 p-4">
        ...
        <div className="justify-items-between mt-4 grid h-full grid-cols-1 gap-4 lg:grid-cols-2">
          {frameworks.map(({ id, name, Icon }) => (
            <div
              key={id}
              className="flex items-center justify-between gap-2 rounded-lg bg-gray-500/30 p-4 text-dark transition-all duration-200 ease-in-out hover:scale-105 hover:cursor-pointer hover:shadow-md dark:bg-white lg:flex-col lg:gap-4"
            >
              <Icon className="h-12 w-12" />
